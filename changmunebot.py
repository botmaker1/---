...
async def on_message(message):
    if message.content.startswith('.도움'):
        await client.send_message(message.channel, "창문이-봇의 도움말입니다. 모든 명령어 앞에는 온점을 붙여주셔야 합니다! .주사위(이건 .주사위를 타이핑 한 후 띄어쓰기 한 후 아무 숫자나 쓴 뒤 ,(쉼표)를 붙여주시고 그 뒤에 또 숫자를 붙여주셔야 합니다. ex).주사위 3,5")  
